...
def main():
    ...
    #modification 1
    print("Train path exists:", os.path.exists(data_dir))
    ...
    list(classifier.parameters()) + list(backbone_model.parameters()),
    lr=5e-5,
    weight_decay=1e-4
    )
    ...
    for epoch in epoch_pbar:
        ...
        checkpoint_path = os.path.join(script_dir, f"checkpoint_epoch_{epoch+1}.pth")
